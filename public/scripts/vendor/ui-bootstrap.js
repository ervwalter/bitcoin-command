...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: '/templates/bootstrap/accordion/accordion.html'
  };
})
...
.directive('accordionGroup', ['$parse', '$transition', '$timeout', function($parse, $transition, $timeout) {
  return {
    ...
    templateUrl:'/templates/bootstrap/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
  return {
    restrict:'EA',
    templateUrl:'/templates/bootstrap/alert/alert.html',
    transclude:true,
    replace:true,
    scope: {
      type: '=',
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: '/templates/bootstrap/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '=',
      noPause: '='
...
.directive('slide', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: '/templates/bootstrap/carousel/slide.html',
    scope: {
    },
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: '/templates/bootstrap/datepicker/datepicker.html',
    scope: {
      dateDisabled: '&'
    },
...
.directive('datepickerPopupWrap', [function() {
  return {
    ...
    replace: true,
    transclude: true,
    templateUrl: '/templates/bootstrap/datepicker/popup.html',
    link:function (scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: '/templates/bootstrap/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
...
.directive('pagination', ['paginationConfig', function(config) {
  return {
    ...
    templateUrl: '/templates/bootstrap/pagination/pagination.html',
    replace: true,
...
.directive('pager', ['pagerConfig', function(config) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: '/templates/bootstrap/pagination/pager.html',
    replace: true,
    link: function(scope, element, attrs, paginationCtrl) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: '/templates/bootstrap/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: '/templates/bootstrap/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: '/templates/bootstrap/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: '/templates/bootstrap/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: '/templates/bootstrap/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function(ratingConfig, $parse) {
  return {
    ...
    templateUrl: '/templates/bootstrap/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: '/templates/bootstrap/tabs/tabset.html',
...
function($parse, $http, $templateCache, $compile) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: '/templates/bootstrap/tabs/tab.html',
    transclude: true,
    scope: {
      heading: '@',
...
.directive('tabsetTitles', function($http) {
  return {
    restrict: 'A',
    require: '^tabset',
    templateUrl: '/templates/bootstrap/tabs/tabset-titles.html',
    replace: true,
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
  return {
    ...
    require:'ngModel',
    replace: true,
    templateUrl: '/templates/bootstrap/timepicker/timepicker.html',
    scope: {
        model: '=ngModel'
    },
    link: function(scope, element, attrs, ngModelCtrl) {
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl:'/templates/bootstrap/typeahead/typeahead-popup.html',
      link:function (scope, element, attrs) {
  ...
  .directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse', function ($http, $templateCache, $compile, $parse) {
    return {
      ...
      link:function (scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || '/templates/bootstrap/typeahead/typeahead-match.html';
